...
export function EmailCard({ email }: { email: EmailSummary }) {
  return (
    <div className="flex flex-col gap-0.5 rounded border border-neutral-800 bg-neutral-950 px-3 py-2">
      ...
      <div className="truncate text-sm text-neutral-200">{email.subject}</div>
